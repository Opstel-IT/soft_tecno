...
@section('content')
                ...
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_img->where('sec', 'blog_sec_1')) < 1)
        ...
        <div class="col-6 mb-3">
            <div class="preview-list">
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            <h6 class="preview-subject">Section 2 (Category)</h6>
                            <p class="text-muted mb-0">Blog Category</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-6 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'blog_sec_2_title')) < 1)
                                            ...
                                            <div class="modal-content ">
                                                ...
                                                <div class="modal-body" style="color: #cab562;">
                                                    <form class="forms-sample"
                                                        action="{{ route('category.update', $postData->id) }}"
                                                        ...
                                                        <div class="row ml-2  d-none">
                                                            <div class="form-group row">
                                                                ...
                                                                <input style="width:90%; " type="text" maxlength="250"
                                                                    ...
                                                                    value="{!! $postData->page !!}" placeholder=" Page..."
                                                                    required>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Cancel</button>
                                                    <a type="button" class="btn btn-danger"
                                                        href="{{ route('blog_cat.delete', $postData->id) }}">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="nav-item col-lg-3 float-right mb-3 mt-2 d-none" style="padding-right: 4.3%;">
                            <a class="nav-link btn btn-info create-new-button px-3">Blog Post</a>
                        </li>
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            <a class="nav-link btn btn-success create-new-button px-3 mr-1" data-bs-toggle="modal"
                                data-bs-target=".blogAdd" id=""> + create </a>
                        </li>
                    </ul>
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($blog as $postData)
                                    <tr>
                                        <td>{!! $postData->CreatedName->name ?? '' !!}</td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a type="button" class="btn btn-outline-primary" data-bs-toggle="modal"
                                                    data-bs-target="#blog_edit{{ $postData->id }}">
                                                    <i class="mdi mdi-grease-pencil"></i>
                                                </a>
                                                <a type="button" class="btn btn-outline-danger" data-bs-toggle="modal"
                                                    data-bs-target="{{ '#blog_delete' . $postData->id }}">
                                                    <i class="mdi mdi-delete"></i>
                                                </a>
                                            </div>
                                        </td>
                                    ...
                                    {{-- Update Modal  --}}
                                    <div class="modal fade " id="blog_edit{{ $postData->id }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true"
                                        style="padding-top: 20px; background: rgba(10, 10, 13, 0.8);">
                                        <div class="modal-dialog" style="max-width:1000px !important;">
                                            <div class="modal-content ">
                                                ...
                                                <div class="modal-body" style="color: #cab562;">
                                                    <form class="forms-sample"
                                                        action="{{ route('blog.update', $postData->id) }}" method="POST"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <select style="width: 90% " class="form-control"
                                                                        ...
                                                                        @foreach ($category as $data)
                                                                            <option
                                                                                {{ $postData->category_id == $data->id ? 'selected' : '' }}
                                                                                value="{{ $data->id }}">
                                                                                {{ $data->title }}</option>
                                                                        @endforeach
                                                                    </select>
                                                        ...
                                                        <h4 class="ml-2 mb-3 mt-3 display-5 ">SEO Section</h4>
                                    ...
                                    {{-- Delete Modal  --}}
                                    <div class="modal fade" id="blog_delete{{ $postData->id }}" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                                        data-bs-dismiss="modal">Cancel</button>
                                                    <a type="button" class="btn btn-danger"
                                                        href="{{ route('blog.delete', $postData->id) }}">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row ml-2 d-none">
                            <div class="form-group row">
                                ...
                                <input style="width:90%; " type="text" maxlength="250" class="form-control "
                                    name="page" id="exampleInputUsername1" value="blog" placeholder=" Page..."
                                    required>
                                <span class="text-danger">
                                    @error('page')
                                        {{ $message }}
    ...
    <!-- Add Modal Blog -->
    <div class="modal fade blogAdd" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true" style="padding-top: 20px; background: rgba(10, 10, 13, 0.8);">
        <div class="modal-dialog" style="max-width:1000px !important;">
            <div class="modal-content ">
                <div class="modal-header">
                ...
                <div class="modal-body" style="color: #cab562;">
                    <form class="forms-sample" action="{!! route('blog.create') !!}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <h4 class="ml-2 mb-3 display-5">Add Data</h4>
                        ...
                        <div class="row ml-2">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:#c6b6b6;">Category*</label>
                                    <select style="width:95% !important;" class="form-control" name="category_id"
                                        required>
                                        <option value="" disabled selected>Select a Category</option>
                                        @foreach ($category->where('status', '0') as $data)
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:#c6b6b6;">Image &nbsp; &nbsp; &nbsp;</label>
                                    <input style="width:95% !important;" type="file" maxlength="250"
                                        class="form-control p-1" name="img" id="exampleInputUsername1"
                                        value="{{ old('img') }}" placeholder="Type Name...">
                                    <span class="text-danger">
                                        @error('img')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:#c6b6b6;">Alt Image</label>
                                    <input style="width:95% !important;" type="text" maxlength="250"
                                        class="form-control " name="alt_img" id="exampleInputUsername1"
                                        value="{{ old('alt_img') }}" placeholder=" Alt Image...">
                                    <span class="text-danger">
                                        @error('alt_img')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label style="color:#c6b6b6;">Status* &nbsp; &nbsp; &nbsp;</label>
                                    <select style="width:95% !important;" class="form-control" name="status">
                                        <option value="0">Active</option>
                                        <option value="1">Dactive</option>
                                    </select>
                                </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body" style="color: #cab562;">
                    <form class="forms-sample" action="{{ route('seo.create') }}" method="POST"
                        ...
                        @csrf
                        <h4 class="ml-2 mb-3 display-5">SEO Section</h4>
                        <input class="d-none" type="text" name="page" value="blog">
                        <div class="row ml-2 ">
                            <div class="col-md-12 " style="padding: 0px 32px 0px 0px;">
                                <div class="form-group  ">
                                    <label for="exampleInputUsername1" style="color:#c6b6b6;">Meta Title </label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sec1,#sec1_edit').click(function() {
                $("#sec_img").val('blog_sec_1');
                $(".banner").val('banner');
            });
            // Icon
            $('#sec2,#sec2_edit').click(function() {
                $("#sec_icon").val('blog_sec_2_title');
