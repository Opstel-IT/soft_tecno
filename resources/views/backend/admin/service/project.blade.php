    ...
    <div class="page-header">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Start Project</li>
            </ol>
        </nav>
    </div>
                ...
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_img->where('sec', 'project_sec_1')) < 1)
        ...
        <div class="col-lg-6 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'project_sec_2_title')) < 1)
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'project_sec_2_title') as $postData)
                                    <tr>
        ...
        <div class="col-lg-6 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'project_sec_3_title')) < 1)
                                <a class="nav-link btn btn-success create-new-button px-3 mr-1"
                                    data-bs-toggle="modal" data-bs-target=".cw_icon" id="sec3_title"> + create </a>
                            @endif
                        </li>
                    </ul>
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'project_sec_3_title') as $postData)
                                    <tr>
                                        <td>{!! Str::limit(strip_tags($postData->title), 50, '...') !!}</td>
                                        <td>{!! Str::limit(strip_tags($postData->des), 50, '...') !!}</td>
                                        <td>
                ...
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">From Title</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'project_sec_4_title')) < 1)
                                <a class="nav-link btn btn-success create-new-button px-3 mr-1"
                                    data-bs-toggle="modal" data-bs-target=".cw_icon" id="sec4_title"> + create </a>
                            @endif
                        </li>
                    </ul>
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'project_sec_4_title') as $postData)
                                    <tr>
                                        <td>{!! Str::limit(strip_tags($postData->title), 50, '...') !!}</td>
                                        <td>{!! Str::limit(strip_tags($postData->des), 50, '...') !!}</td>
                                        <td>
                        ...
                        <div class="row ml-2 d-none">
                            <div class="form-group row">
                                ...
                                <input style="width:90%; " type="text" maxlength="250" class="form-control "
                                    name="page" id="exampleInputUsername1" value="project" placeholder=" Page..."
                                    required>
                                <span class="text-danger">
                                    @error('page')
                                        {{ $message }}
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body" style="color: #cab562;">
                    <form class="forms-sample" action="{{ route('seo.create') }}" method="POST"
                        ...
                        @csrf
                        <h4 class="ml-2 mb-3 display-5">SEO Section</h4>
                        <input class="d-none" type="text" name="page" value="project">
                        <div class="row ml-2 ">
                            <div class="col-md-12 " style="padding: 0px 32px 0px 0px;">
                                <div class="form-group  ">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sec1,#sec1_edit').click(function() {
                $("#sec_img").val('project_sec_1');
                $(".banner").val('banner');
            });
            // Icon
            $('#sec2,#sec2_edit').click(function() {
                $("#sec_icon").val('project_sec_2_title');
                $(".icon_img,.icon_link").hide();
            });
            // Icon
            $('#sec3_title,#sec3_edit').click(function() {
                $("#sec_icon").val('project_sec_3_title');
                $(".icon_img,.icon_link").hide();
            });
            // Icon
            $('#sec4_title,#sec4_edit').click(function() {
                $("#sec_icon").val('project_sec_4_title');
                $(".icon_img,.icon_link").hide();
            });
        });
    </script>
