...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">{!! $serviceDetails->title !!} Page</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item" aria-current="page"><a href="{!! route('Admin.service') !!}">Services</a></li>
            ...
            <div class="preview-list">
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            <h6 class="preview-subject">{!! $serviceDetails->title !!} Hero Section</h6>
                ...
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_img->where('sec', 'serviceDetails_sec_1')) < 1)
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_img->where('sec', 'serviceDetails_sec_1') as $postData)
                                    <tr>
                ...
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">{!! $serviceDetails->title !!} About.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_img->where('sec', 'serviceDetails_sec_2')) < 1)
                                <a class="nav-link btn btn-success create-new-button px-3 addpage mr-1"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_img->where('sec', 'serviceDetails_sec_2') as $postData)
                                    <tr>
                                        <td>{{ $postData->title }}</td>
                                        <td>{{ $postData->button_name }}</td>
                                        <td>{{ $postData->button_link }}</td>
        ...
        <div class="col-5 mb-3">
            <div class="preview-list">
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            <h6 class="preview-subject">Section 3 (Title)</h6>
                            <p class="text-muted mb-0">{!! $serviceDetails->title !!} Feature Title.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-7 mb-3">
            <div class="preview-list">
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            <h6 class="preview-subject">Section 3 (Content)</h6>
                            <p class="text-muted mb-0">{!! $serviceDetails->title !!} Features.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'serviceDetails_sec_3_title')) < 1)
                                <a class="nav-link btn btn-success create-new-button px-3 mr-1"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'serviceDetails_sec_3_title') as $postData)
                                    <tr>
        ...
        <div class="col-lg-7 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'serviceDetails_sec_3_content')) < 1)
                                <a class="nav-link btn btn-success create-new-button px-3 mr-1"
                                    data-bs-toggle="modal" data-bs-target=".cw_icon" id="sec3_content"> + create </a>
                            @endif
                        </li>
                    </ul>
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'serviceDetails_sec_3_content') as $postData)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a type="button" id="sec3_content_edit" class="btn btn-outline-primary"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#cw_edit_icon{{ $postData->id }}">
                                                    <i class="mdi mdi-grease-pencil"></i>
                                                </a>
                ...
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">{!! $serviceDetails->title !!} Pricing Title.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">{!! $serviceDetails->title !!} Pricing Cart.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-5 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'serviceDetails_sec_4_title')) < 1)
                                <a class="nav-link btn btn-success create-new-button px-3 mr-1"
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover ">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'serviceDetails_sec_4_title') as $postData)
                                    <tr>
                                        <td>{!! Str::limit(strip_tags($postData->title), 50, '...') !!}</td>
                                        <td>{!! Str::limit(strip_tags($postData->des), 50, '...') !!}</td>
                                        <td>
        ...
        <div class="col-12 mb-3">
            <div class="preview-list">
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            <h6 class="preview-subject">Section 5 (Happy Client)</h6>
                            <p class="text-muted mb-0">This section will come from the <a href="{!! route('Admin.home') !!}">Home</a> page Section 10.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row ml-2 d-none">
                            <div class="form-group row">
                                ...
                                <input style="width:90%; " type="text" maxlength="250" class="form-control "
                                    name="page" id="exampleInputUsername1" value="{!! $serviceDetails->id !!}" placeholder="Page..."
                                    required>
                        ...
                        <form class="forms-sample" action="{{ route('cw_image.update', $postData->id) }}"
                            ...
                            <div class="row ml-2 d-none">
                                <div class="form-group row">
                                    <input type="text" class="banner" name="banner">
                                    <input style="width:90%; " type="text" maxlength="250" class="form-control "
                                        name="page" id="exampleInputUsername1" value="{!! $serviceDetails->id !!}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sec1,#sec1_edit').click(function() {
                $("#sec_img").val('serviceDetails_sec_1');
                $(".banner").val('banner');
            });
            // Image
            $('#sec2,#sec2_edit').click(function() {
                $("#sec_img").val('serviceDetails_sec_2');
            });
            // Icon
            $('#sec3,#sec3_edit').click(function() {
                $("#sec_icon").val('serviceDetails_sec_3_title');
                $(".icon_img,.icon_link").hide();
            });
            // Icon
            $('#sec3_content,#sec3_content_edit').click(function() {
                $("#sec_icon").val('serviceDetails_sec_3_content');
                $(".icon_img").hide();
                $(".icon_link").show();
            });
            // Icon
            $('#sec4,#sec4_edit').click(function() {
                $("#sec_icon").val('serviceDetails_sec_4_title');
                $(".icon_img,.icon_link").hide();
            });
        });
    </script>
