                ...
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_img->where('sec', 'faq_sec_1')) < 1)
        ...
        <div class="col-lg-12 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            @if (count($cw_icon->where('sec', 'faq_sec_2_title')) < 1)
                ...
                <div class="preview-item border-bottom">
                    ...
                    <div class="preview-item-content d-sm-flex flex-grow">
                        <div class="flex-grow">
                            ...
                            <p class="text-muted mb-0">FAQ Content</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card ">
            <div class="card">
                <div class="card-body">
                    <ul class="navbar-nav d-inline mb-3">
                        <li class="breadcrumb-item p-2 col-lg-9 mb-3">
                            {{-- @if (count($cw_icon->where('sec', 'faq_sec_2_content')) < 1) --}}
                                <a class="nav-link btn btn-success create-new-button px-3 hide_sec6 mr-1"
                                    data-bs-toggle="modal" data-bs-target=".cw_icon" id="sec2_content"> + create </a>
                            {{-- @endif --}}
                        </li>
                    </ul>
                    <div class="table-responsive">
                            ...
                            <tbody>
                                @foreach ($cw_icon->where('sec', 'faq_sec_2_content') as $postData)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a type="button" id="sec2_edit_content" class="btn btn-outline-primary"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#cw_edit_icon{{ $postData->id }}">
                                                    <i class="mdi mdi-grease-pencil"></i>
                                                </a>
                        ...
                        <div class="row ml-2 d-none">
                            <div class="form-group row">
                                ...
                                <input style="width:90%; " type="text" maxlength="250" class="form-control "
                                    name="page" id="exampleInputUsername1" value="faq" placeholder=" Page..."
                                    required>
                                <span class="text-danger">
                                    @error('page')
                                        {{ $message }}
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body" style="color: #cab562;">
                    <form class="forms-sample" action="{{ route('seo.create') }}" method="POST"
                        ...
                        @csrf
                        <h4 class="ml-2 mb-3 display-5">SEO Section</h4>
                        <input class="d-none" type="text" name="page" value="faq">
                        <div class="row ml-2 ">
                            <div class="col-md-12 " style="padding: 0px 32px 0px 0px;">
                                <div class="form-group  ">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sec1,#sec1_edit').click(function() {
                $("#sec_img").val('faq_sec_1');
                $(".banner").val('banner');
            });
            // Icon
            $('#sec2,#sec2_edit').click(function() {
                $("#sec_icon").val('faq_sec_2_title');
                $(".icon_img,.icon_link").hide();
            });
            // Icon
            $('#sec2_content,#sec2_edit_content').click(function() {
                $("#sec_icon").val('faq_sec_2_content');
                $(".icon_img,.icon_link").hide();
            });
        });
    </script>
